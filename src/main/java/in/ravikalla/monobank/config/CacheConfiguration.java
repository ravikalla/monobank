package in.ravikalla.monobank.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("monobank");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("monobank");
        ...
        config.getMapConfigs().put("in.ravikalla.monobank.domain.*", initializeDomainMapConfig(jHipsterProperties));
